...
class EmojiTableViewController: UITableViewController {
    ...
    var objects = [
        ...
        Emoji(emoji: "🏈", name: "Football", description: "Let`s play footbal together", isFavorite: false),
    ...
    func doneAction(at indexPath: IndexPath) -> UIContextualAction {
        let action = UIContextualAction(style: .destructive, title: "Done") { (actoin, view, completion) in
